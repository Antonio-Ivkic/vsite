...
namespace Vsite.CSharp.KontrolaToka
{
    public class NaredbeBreakContinue
    {
        public static int ZbrojiDoNSveKojiSuDjeljiviSaD(int n, int d)
        {
            ...
            for (int i = 1; i <= n; ++i)
            {
                // TODO:101 Ako i nije djeljiv s d, ne dodaje se (tj. treba se vratiti na početak petlje naredbom continue)
        ...
        public static int ZbrojiDoNSveKojiSuDjeljiviSaDAliSamoDoPrvogDjeljivogSaD2(int n, int d, int d2)
        {
            ...
            for (int i = 1; i <= n; ++i)
            {
                // TODO:102 Ako i nije djeljiv s d, ne dodaje se (tj. treba se vratiti na početak petlje)


                // TODO:103 Ako je i djeljiv sa d2, tada treba prekinuti petlju
